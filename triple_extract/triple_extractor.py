...
# 读取label2id字典
with open("../data/ccks2019_label2id.json", "r", encoding="utf-8") as h:
...
ner_model = load_model("../model/ccks2019_ner.h5", custom_objects=custom_objects)

# 载入分类模型
best_model_path = '../model/per-rel-19-0.9329.h5'
